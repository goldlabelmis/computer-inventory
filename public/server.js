...
// 1. Connect to MongoDB Atlas (Replace with your Atlas connection string or use process.env.MONGO_URI)
...
app.post('/api/auth/login', (req, res) => {
  ...
  if (username === 'GoldlabelMis' && password === 'GLDOREEN2026') {
...
app.delete('/api/computers/:id', requireAuth, async (req, res) => {
...
/* --- REPAIR LOGS ROUTES --- */
app.post('/api/repair-logs', requireAuth, async (req, res) => {
...
app.put('/api/repair-logs/:id', requireAuth, async (req, res) => {
...
app.delete('/api/repair-logs/:id', requireAuth, async (req, res) => {
  await Computer.updateOne(
